{
  inputs = {
    ...
    nixpkgs-nov-21-23.url = "nixpkgs/e4ad989506ec7d71f7302cc3067abd82730a4beb";
  ...
  outputs =
    ...
    flake-utils.lib.eachDefaultSystem
      ...
      let
        ...
        pkgs-nov-21-23 = nixpkgs-nov-21-23.legacyPackages.${system};
      ...
      let
        out = rec {
          ...
          packages = import ./nix/packages.nix {
            inherit pkgs atomi atomi_classic pkgs-2305 pkgs-nov-21-23;
          };
